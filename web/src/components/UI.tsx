...
export const Button = ({ children, onClick, variant = 'primary', className = '', size = 'md', ...props }: any) => {
    ...
    return <button onClick={onClick} className={base + variants[variant] + " " + sizes[size] + " " + className} {...props}>{children}</button>;
};
...
export const Input = ({ label, className = "", ...props }: any) => (
    <div className="flex flex-col gap-2 w-full">
        ...
        <input className={"flex h-11 w-full rounded-xl bg-zinc-900 border border-zinc-800 px-4 py-2 text-sm text-zinc-100 transition-all placeholder:text-zinc-600 focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500/20 outline-none disabled:opacity-50 " + className} {...props} />
    </div>
);

export const Card = ({ children, title, description, className = "", ...props }: any) => (
    <div className={"bg-zinc-900/50 border border-zinc-800/50 rounded-2xl p-6 backdrop-blur-sm " + className} {...props}>
        {(title || description) && (
            <div className="mb-6">
...
export const Icon = ({ name, size = 18 }: any) => {
    const icons: any = {
        dashboard: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="7" height="9" x="3" y="3" rx="1" /><rect width="7" height="5" x="14" y="3" rx="1" /><rect width="7" height="9" x="14" y="12" rx="1" /><rect width="7" height="5" x="3" y="16" rx="1" /></svg>,
        chat: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" /></svg>,
        ...
        vault: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>,
        ...
        send: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m22 2-7 20-4-9-9-4Z" /><path d="M22 2 11 13" /></svg>,
        chat_alt: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>,
        globe: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="2" x2="22" y1="12" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>,
        ...
        terminal: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="4 17 10 11 4 5" /><line x1="12" x2="20" y1="19" y2="19" /></svg>
    };
