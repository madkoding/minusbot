    ...
    return (
        <div className="space-y-12 max-w-6xl mx-auto pb-20">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        <h2 className="text-2xl font-bold tracking-tight text-zinc-100">System Updates</h2>
                        <div className="h-px w-10 bg-zinc-800 ml-4 opacity-50 hidden md:block"></div>
                    </div>
                    <p className="text-zinc-500 text-sm font-medium">Keep your assistant up to date with the latest features and security improvements.</p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        ...
                        {updating ? "Updating System..." : "Install Updates"}
                    </button>
                </div>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card title="Available Assets" description="Pending updates for your system">
            ...
            {lastOutput && (
                <Card title="Synchronization Output" description="Details from the last update process">
            ...
            <div>
                <header className="mb-8">
                    ...
                    <p className="text-xs text-zinc-600 mt-1 font-medium">Chronological record of feature sets and system improvements.</p>
                </header>
