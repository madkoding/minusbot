            ...
            <div className="max-w-5xl mx-auto h-full p-4 md:p-0">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 md:mb-8 gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-xl md:text-2xl font-bold text-zinc-100 truncate">{selectedSkill?.id || "New Skill"}</h2>
                    </div>
            ...
            <div className="space-y-8 md:space-y-12 max-w-6xl mx-auto">
                <header className="flex flex-col md:flex-row md:justify-between md:items-end gap-6">
                    ...
                    <div className="md:ml-10">
                        <Button onClick={() => { setIsEditing(true); setSelectedSkill(null); setEditData({ skillJson: {}, scriptPy: "" }); }} size="sm" className="rounded-xl w-full md:w-auto h-11 px-6 shadow-xl">
                            Create New Skill
                        </Button>
                    </div>
                </header>
